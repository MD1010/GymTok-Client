...
import { repliesSelector } from "../../store/replies/repliesSlice";
...
export const PostReplies: React.FC<PostRepliesProps> = ({ navigationParam }) => {
  ...
  const { latestNewReply } = useSelector(repliesSelector);
